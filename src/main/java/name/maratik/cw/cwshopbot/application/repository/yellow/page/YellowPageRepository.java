...
public interface YellowPageRepository extends Repository<YellowPageEntity, String>, CustomizedYellowPageRepository {
    ...
    @Query("" +
        "SELECT link, name, owner_name, owner_castle, profession, mana, max_mana, maintenance_enabled, maintenance_cost, guild_discount, castle_discount, active, last_active_time" +
        "  FROM yellow_page" +
        " WHERE link = :link")
