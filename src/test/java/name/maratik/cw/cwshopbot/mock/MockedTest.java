...
import name.maratik.cw.cwshopbot.application.dao.DaoException;
import name.maratik.cw.cwshopbot.application.dao.ShopDao;
import name.maratik.cw.cwshopbot.application.dao.ShopLineDao;
import name.maratik.cw.cwshopbot.model.Shop;
import name.maratik.cw.cwshopbot.model.ShopLine;
import name.maratik.cw.cwshopbot.application.Application;
import name.maratik.cw.cwshopbot.application.config.InternalConfig;
import name.maratik.cw.cwshopbot.application.config.MocksConfig;
import name.maratik.cw.cwshopbot.application.config.TestDynamoDBConfig;
import name.maratik.cw.cwshopbot.application.dao.DaoException;
import name.maratik.cw.cwshopbot.application.dao.ShopDao;
import name.maratik.cw.cwshopbot.application.dao.ShopLineDao;
import name.maratik.cw.cwshopbot.model.Shop;
